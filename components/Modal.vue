    ...
    <div class="modal" v-if="isOpen">
        <div class="modal__wrapper">
            ...
            <div class="modal__input" v-if="showInput">
                <input @focus="error = ''"  @keypress="isLetter($event)" @keyup.enter="changeCity" type="text" placeholder="Type your city.." v-model="otherCity">
            ...
            <div class="modal__buttons" v-else>
                <button class="modal__button modal__button_green" @click="isOpen = false">Yes</button>
                <button class="modal__button modal__button_red" @click="showInput = true">No</button>
            </div>
            </div>
        </div>
    </div>
...
export default {        
    ...
    created(){
      if (this.$route.query.city) this.isOpen = false
